...
saveas(gcf, fullfile('plot', 'tau.eps'), 'epsc');
...
saveas(gcf, fullfile('plot', 'NED.eps'), 'epsc');
...
saveas(gcf, fullfile('plot', 'ep.eps'), 'epsc');
...
legend({'$e_{\eta}$', '$e_{\epsilon_1}$', '$e_{\epsilon_2}$','$e_{\epsilon_3}$'}, 'Interpreter','latex', 'Location','best');
saveas(gcf, fullfile('plot', 'eO.eps'), 'epsc');
...
saveas(gcf, fullfile('plot', 'LinearVel.eps'), 'epsc');
...
saveas(gcf, fullfile('plot', 'AngularVel.eps'), 'epsc');
